...
var TestThirdPartyStrategy = /** @class */ (function (_super) {
    __extends(TestThirdPartyStrategy, _super);
    function TestThirdPartyStrategy() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TestThirdPartyStrategy.prototype.authenticate = function (_request, _options) {
        return this.success((0, helpers_1.generateTestUser)());
    };
    return TestThirdPartyStrategy;
...
var testSuite = function (sessionPluginName) {
    (0, node_test_1.describe)("".concat(sessionPluginName, " tests"), function () {
        (0, node_test_1.describe)('.authorize', function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            (0, tsd_1.expectType)(fastifyPassport.authorize('third-party'));
                            server.get('/', { preValidation: fastifyPassport.authorize('third-party') }, function (request) { return __awaiter(void 0, void 0, void 0, function () {
                                var user, account;
