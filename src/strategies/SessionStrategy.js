...
var SessionStrategy = /** @class */ (function (_super) {
    ...
    function SessionStrategy(options, deserializeUser) {
        ...
        if (typeof options === 'function') {
            _this.deserializeUser = options;
        }
        else if (typeof deserializeUser === 'function') {
            _this.deserializeUser = deserializeUser;
        }
        else {
     ...
     * @api protected
     */
    SessionStrategy.prototype.authenticate = function (request, options) {
        var _this = this;
        if (!request.passport) {
        ...
        var sessionUser = request.passport.sessionManager.getUserFromSession(request);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, request.passport.sessionManager.logOut(request)];
                        case 1:
                            _a.sent();
                            return [3 /*break*/, 3];
                        case 2:
